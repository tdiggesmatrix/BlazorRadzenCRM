...
{
    public partial class UspDashboardGetStatisticsCustomersController : ODataController
    {
        private ThrottleCoreCRM.Server.Data.Throttle_Core_SummaryContext context;

        public UspDashboardGetStatisticsCustomersController(ThrottleCoreCRM.Server.Data.Throttle_Core_SummaryContext context)
        {
        ...
        [HttpGet]
        [Route("odata/Throttle_Core_Summary/UspDashboardGetStatisticsCustomersFunc(WebUserID={WebUserID},CustomerID={CustomerID},Stores={Stores},Groups={Groups},StartDate={StartDate},EndDate={EndDate},OnlyActiveStores={OnlyActiveStores},ext_Daily={ext_Daily},ext_WTD={ext_WTD},ext_MTD={ext_MTD},ext_YTD={ext_YTD},ext_DOD={ext_DOD},ext_WOW={ext_WOW},ext_MOM={ext_MOM},ext_YOY={ext_YOY})")]
        public IActionResult UspDashboardGetStatisticsCustomersFunc([FromODataUri] int? WebUserID, [FromODataUri] int? CustomerID, [FromODataUri] string Stores, [FromODataUri] string Groups, [FromODataUri] string StartDate, [FromODataUri] string EndDate, [FromODataUri] bool? OnlyActiveStores, [FromODataUri] bool? ext_Daily, [FromODataUri] bool? ext_WTD, [FromODataUri] bool? ext_MTD, [FromODataUri] bool? ext_YTD, [FromODataUri] bool? ext_DOD, [FromODataUri] bool? ext_WOW, [FromODataUri] bool? ext_MOM, [FromODataUri] bool? ext_YOY)
        {
            this.OnUspDashboardGetStatisticsCustomersDefaultParams(ref WebUserID, ref CustomerID, ref Stores, ref Groups, ref StartDate, ref EndDate, ref OnlyActiveStores, ref ext_Daily, ref ext_WTD, ref ext_MTD, ref ext_YTD, ref ext_DOD, ref ext_WOW, ref ext_MOM, ref ext_YOY);
            ...
            this.context.Database.ExecuteSqlRaw("EXEC @returnVal=[dbo].[uspDashboardGetStatisticsCustomer] @WebUserID, @CustomerID, @Stores, @Groups, @StartDate, @EndDate, @OnlyActiveStores, @ext_Daily, @ext_WTD, @ext_MTD, @ext_YTD, @ext_DOD, @ext_WOW, @ext_MOM, @ext_YOY", @params);

            int result = Convert.ToInt32(@params[0].Value);

            this.OnUspDashboardGetStatisticsCustomersInvoke(ref result);
