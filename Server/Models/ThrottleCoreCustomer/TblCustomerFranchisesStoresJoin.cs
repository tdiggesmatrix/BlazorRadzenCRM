...
{
    [Table("tblCustomer-Franchises-Stores-Join", Schema = "dbo")]
    public partial class TblCustomerFranchisesStoresJoin
    {
        [Key]
        ...
        [Column("fldCustomer-Franchises-RecordID")]
        [Required]
        public int fldCustomerFranchisesRecordID { get; set; }
