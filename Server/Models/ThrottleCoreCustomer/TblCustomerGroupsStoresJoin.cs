...
{
    [Table("tblCustomer-Groups-Stores-Join", Schema = "dbo")]
    public partial class TblCustomerGroupsStoresJoin
    {
        [Key]
        ...
        [Column("fldCustomer-Groups-RecordID")]
        [Required]
        public int fldCustomerGroupsRecordID { get; set; }
