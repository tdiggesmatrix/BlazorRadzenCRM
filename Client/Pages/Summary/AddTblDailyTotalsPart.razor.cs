...
{
    public partial class AddTblDailyTotalsPart
    {
        [Inject]
        ...
        {
            tblDailyTotalsPart = new ThrottleCoreCRM.Server.Models.Throttle_Core_Summary.TblDailyTotalsPart();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_SummaryService.CreateTblDailyTotalsPart(tblDailyTotalsPart);
