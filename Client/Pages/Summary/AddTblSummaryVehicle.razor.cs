...
{
    public partial class AddTblSummaryVehicle
    {
        [Inject]
        ...
        {
            tblSummaryVehicle = new ThrottleCoreCRM.Server.Models.Throttle_Core_Summary.TblSummaryVehicle();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_SummaryService.CreateTblSummaryVehicle(tblSummaryVehicle);
