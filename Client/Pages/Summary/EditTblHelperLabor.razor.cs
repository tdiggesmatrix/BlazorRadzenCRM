...
{
    public partial class EditTblHelperLabor
    {
        [Inject]
        ...
        {
            tblHelperLabor = await Throttle_Core_SummaryService.GetTblHelperLaborByFldRecordId(fldRecordId:fldRecordID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_SummaryService.UpdateTblHelperLabor(fldRecordId:fldRecordID, tblHelperLabor);
