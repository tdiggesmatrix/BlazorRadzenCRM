...
{
    public partial class AddTblHelperMailAddressError
    {
        [Inject]
        ...
        {
            tblHelperMailAddressError = new ThrottleCoreCRM.Server.Models.Throttle_Core_Summary.TblHelperMailAddressError();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_SummaryService.CreateTblHelperMailAddressError(tblHelperMailAddressError);
