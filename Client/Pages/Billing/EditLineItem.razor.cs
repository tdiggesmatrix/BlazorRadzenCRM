...
{
    public partial class EditLineItem
    {
        [Inject]
        ...
        {
            lineItem = await Throttle_Core_BillingService.GetLineItemByFldRecordId(fldRecordId:fldRecordID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_BillingService.UpdateLineItem(fldRecordId:fldRecordID, lineItem);
