...
{
    public partial class AddBulkBilling
    {
        [Inject]
        ...
        {
            bulkBilling = new ThrottleCoreCRM.Server.Models.Throttle_Core_Billing.BulkBilling();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_BillingService.CreateBulkBilling(bulkBilling);
