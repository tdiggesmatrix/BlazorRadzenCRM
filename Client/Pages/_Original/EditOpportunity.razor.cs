...
namespace ThrottleCoreCRM.Client.Pages._Original
{
    public partial class EditOpportunity
    {
        ...
        {
            opportunity = await Throttle_Core_WebSiteService.GetOpportunityById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_WebSiteService.UpdateOpportunity(id:Id, opportunity);
