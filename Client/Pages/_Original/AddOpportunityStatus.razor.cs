...
namespace ThrottleCoreCRM.Client.Pages._Original
{
    public partial class AddOpportunityStatus
    {
        ...
        {
            opportunityStatus = new ThrottleCoreCRM.Server.Models.Throttle_Core_WebSite.OpportunityStatus();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_WebSiteService.CreateOpportunityStatus(opportunityStatus);
