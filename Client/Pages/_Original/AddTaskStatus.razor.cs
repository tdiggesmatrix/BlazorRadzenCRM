...
namespace ThrottleCoreCRM.Client.Pages._Original
{
    public partial class AddTaskStatus
    {
        ...
        {
            taskStatus = new ThrottleCoreCRM.Server.Models.Throttle_Core_WebSite.TaskStatus();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_WebSiteService.CreateTaskStatus(taskStatus);
