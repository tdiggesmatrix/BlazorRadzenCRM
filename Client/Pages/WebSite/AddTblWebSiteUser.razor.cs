...
{
    public partial class AddTblWebSiteUser
    {
        [Inject]
        ...
        {
            tblWebSiteUser = new ThrottleCoreCRM.Server.Models.Throttle_Core_WebSite.TblWebSiteUser();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_WebSiteService.CreateTblWebSiteUser(tblWebSiteUser);
