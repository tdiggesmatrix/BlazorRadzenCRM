...
{
    public partial class AddTblWebSiteSecurityGroup
    {
        [Inject]
        ...
        {
            tblWebSiteSecurityGroup = new ThrottleCoreCRM.Server.Models.Throttle_Core_WebSite.TblWebSiteSecurityGroup();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_WebSiteService.CreateTblWebSiteSecurityGroup(tblWebSiteSecurityGroup);
