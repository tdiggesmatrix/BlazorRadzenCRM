...
{
    public partial class AddTblCustomerFranchisesStoresJoin
    {
        [Inject]
        ...
        {
            tblCustomerFranchisesStoresJoin = new ThrottleCoreCRM.Server.Models.Throttle_Core_Customer.TblCustomerFranchisesStoresJoin();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_CustomerService.CreateTblCustomerFranchisesStoresJoin(tblCustomerFranchisesStoresJoin);
