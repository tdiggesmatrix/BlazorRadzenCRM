...
{
    public partial class AddTblDataDmSFileActivity
    {
        [Inject]
        ...
        {
            tblDataDmSFileActivity = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblDataDmSFileActivity();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblDataDmSFileActivity(tblDataDmSFileActivity);
