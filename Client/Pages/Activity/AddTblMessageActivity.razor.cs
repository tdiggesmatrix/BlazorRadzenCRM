...
{
    public partial class AddTblMessageActivity
    {
        [Inject]
        ...
        {
            tblMessageActivity = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblMessageActivity();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblMessageActivity(tblMessageActivity);
