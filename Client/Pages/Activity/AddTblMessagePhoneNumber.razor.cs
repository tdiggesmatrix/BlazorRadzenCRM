...
{
    public partial class AddTblMessagePhoneNumber
    {
        [Inject]
        ...
        {
            tblMessagePhoneNumber = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblMessagePhoneNumber();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblMessagePhoneNumber(tblMessagePhoneNumber);
