...
{
    public partial class AddTblMessageUsage
    {
        [Inject]
        ...
        {
            tblMessageUsage = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblMessageUsage();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblMessageUsage(tblMessageUsage);
