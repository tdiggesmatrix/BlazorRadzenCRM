...
{
    public partial class AddTblMessageNotification
    {
        [Inject]
        ...
        {
            tblMessageNotification = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblMessageNotification();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblMessageNotification(tblMessageNotification);
