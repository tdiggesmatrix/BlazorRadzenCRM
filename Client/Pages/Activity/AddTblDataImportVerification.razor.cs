...
{
    public partial class AddTblDataImportVerification
    {
        [Inject]
        ...
        {
            tblDataImportVerification = new ThrottleCoreCRM.Server.Models.Throttle_Core_Activity.TblDataImportVerification();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await Throttle_Core_ActivityService.CreateTblDataImportVerification(tblDataImportVerification);
